// @observablehq/runtime v5.8.2 Copyright 2023 Observable, Inc.
function e(e, t, n) {
    n = n || {};
...
function W(e, t) {
    ...
    return `${((i = e.getUTCFullYear()),
            i < 0 ? `-${H(-i, 6)}` : i > 9999 ? `+${H(i, 6)}` : H(i, 4))
        }-${H(e.getUTCMonth() + 1, 2)}-${H(e.getUTCDate(), 2)}${n || r || a || o
            ? `T${H(n, 2)}:${H(r, 2)}${a || o ? `:${H(a, 2)}${o ? `.${H(o, 3)}` : ""}` : ""
            }Z`
            : ""
        }`;
    var i;
...
const Ne = Ce("d3", "7.8.5", "dist/d3.min.js"),
    xe = Ce("@observablehq/inputs", "0.10.5", "dist/inputs.min.js"),
    Te = Ce("@observablehq/plot", "0.6.9", "dist/plot.umd.min.js"),
...
class SQLiteDatabaseClient {
    ...
    async describeTables({ schema: e } = {}) {
        return this.query(
            `SELECT NULLIF(schema, 'main') AS schema, name FROM pragma_table_list() WHERE type = 'table'${null == e ? "" : " AND schema = ?"
    ...
    async describeColumns({ schema: e, table: t } = {}) {
        ...
        const n = await this.query(
            `SELECT name, type, "notnull" FROM pragma_table_info(?${null == e ? "" : ", ?"
            }) ORDER BY cid`,
            null == e ? [t] : [t, e]
        );
                    ...
                    if ("mssql" === t.dialect || "oracle" === t.dialect) {
                        if (null !== s.to || null !== s.from) {
                            ...
                            zt(`\nOFFSET ${s.from || 0} ROWS`, l),
                                zt(
                                    `\nFETCH NEXT ${null !== s.to ? s.to - (s.from || 0) : 1e9
                                    } ROWS ONLY`,
                                    l
                                );
                        }
